/*
 pig -f url_count_all_sessions.pig  -param "time_start_param=2015-07-22T09:01:00.000000Z" -param "time_end_param=2015-07-22T10:02:00.000000Z" -param "input=/opt/paytm/input.log" -param "output=/tmp/outputdir"
*/
...
loginlogout_session = group timefiltered by client;
myoutput = foreach loginlogout_session generate group,mypig.SessionPageHitsCounts(timefiltered);
